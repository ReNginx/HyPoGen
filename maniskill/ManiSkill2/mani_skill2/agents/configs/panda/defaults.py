...
class PandaDefaultConfig:
    def __init__(self, agent_stiffness, agent_damping, urdf_path=None) -> None:
        self.urdf_path = urdf_path if urdf_path is not None else "{PACKAGE_ASSET_DIR}/descriptions/panda_v2.urdf"
        print(f'urdf path is {self.urdf_path}')
        ...
        self.arm_stiffness = agent_stiffness #1e3
        self.arm_damping = agent_damping #1e2
        ...
        self.gripper_stiffness = agent_stiffness #1e3
        self.gripper_damping = agent_damping #1e2
