...
class Panda(BaseAgent):
    ...
    @classmethod
    def get_default_config(cls, agent_stiffness=None, agent_damping=None, urdf_path=None):
        return defaults.PandaDefaultConfig(agent_stiffness, agent_damping, urdf_path)
