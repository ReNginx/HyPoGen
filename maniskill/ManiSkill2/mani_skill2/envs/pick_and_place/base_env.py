...
class StationaryManipulationEnv(BaseEnv):
    ...
    def __init__(self, *args, robot="panda", robot_init_qpos_noise=0.02, **kwargs):
        ...
        self.box_half_size = kwargs.pop('cube_half_size', None)
    ...
    def _configure_agent(self, agent_stiffness, agent_damping, urdf_path=None):
        agent_cls: Type[BaseAgent] = self.SUPPORTED_ROBOTS[self.robot_uid]
        self._agent_cfg = agent_cls.get_default_config(agent_stiffness, agent_damping, urdf_path)
